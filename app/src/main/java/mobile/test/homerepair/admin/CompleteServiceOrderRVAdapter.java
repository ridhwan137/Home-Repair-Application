...
public class CompleteServiceOrderRVAdapter extends RecyclerView.Adapter<CompleteServiceOrderRVAdapter.ViewHolder>{
    private ArrayList<Order> orderArrayList;
    private Context context;
    private CompleteServiceOrderRVAdapter.ItemClickListener mClickListener;
...
//    Services services;
    ...
    public CompleteServiceOrderRVAdapter(ArrayList<Order> orderArrayList, Context context) {
    ...
    @NonNull
    @Override
    public CompleteServiceOrderRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CompleteServiceOrderRVAdapter.ViewHolder holder, int position) {
    ...
    public void setClickListener(CompleteServiceOrderRVAdapter.ItemClickListener itemClickListener) {
