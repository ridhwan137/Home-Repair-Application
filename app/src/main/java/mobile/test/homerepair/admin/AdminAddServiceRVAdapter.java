...
public class AdminAddServiceRVAdapter extends RecyclerView.Adapter<AdminAddServiceRVAdapter.ViewHolder>{
    ...
    private AdminAddServiceRVAdapter.ItemClickListener mClickListener;

    FirebaseFirestore db = FirebaseFirestore.getInstance();

    // creating constructor for our adapter class
    public AdminAddServiceRVAdapter(ArrayList<Services> servicesArrayList, Context context) {
    ...
    @NonNull
    @Override
    public AdminAddServiceRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.test_add_service_type_row, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull AdminAddServiceRVAdapter.ViewHolder holder, int position) {
...
//                    Toast.makeText(context, "serviceTypeID-> "+ getServiceTypeID , Toast.LENGTH_SHORT).show();
    ...
    void setClickListener(AdminAddServiceRVAdapter.ItemClickListener itemClickListener) {
