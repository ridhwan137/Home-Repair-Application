...
public class CancelAppointmentList extends AppCompatActivity implements AppointmentListRVAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancel_appointment_list);
        ...
        et_searchService.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                appointmentListRVAdapter.setClickListener(CancelAppointmentList.this);
                rvAppointment.setAdapter(appointmentListRVAdapter);
