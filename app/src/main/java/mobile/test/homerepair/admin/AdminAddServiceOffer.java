...
public class AdminAddServiceOffer extends AppCompatActivity implements AdminAddServiceOfferRVAdapter.ItemClickListener{

    private RecyclerView rvServiceItem;
    private ArrayList<Services> servicesArrayList;
    private AdminAddServiceOfferRVAdapter adminAddServiceOfferRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminAddServiceOfferRVAdapter = new AdminAddServiceOfferRVAdapter(servicesArrayList, this);

        adminAddServiceOfferRVAdapter.setClickListener(this);

        // setting adapter to our recycler view.
        rvServiceItem.setAdapter(adminAddServiceOfferRVAdapter);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            adminAddServiceOfferRVAdapter.notifyDataSetChanged();
                        } else {
        ...
        db.collection("serviceOffer").document(serviceID)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Intent intent = new Intent(getApplicationContext(), AdminAddServiceOffer.class);
                        intent.putExtra("serviceTypeID", serviceTypeID);
                        intent.putExtra("serviceType", serviceType);
                        startActivity(intent);
                        AdminAddServiceOffer.this.finish();
