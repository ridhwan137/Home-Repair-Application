...
public class AppointmentScheduleListClientTabInProgress extends Fragment implements AppointmentScheduleListClientRVAdapter.ItemClickListener {

    private RecyclerView rvListAppointment;
    private ArrayList<Appointment> appointmentArrayList;
    private AppointmentScheduleListClientRVAdapter appointmentScheduleListClientRVAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        appointmentScheduleListClientRVAdapter = new AppointmentScheduleListClientRVAdapter(appointmentArrayList, getContext());
        appointmentScheduleListClientRVAdapter.setClickListener(this);

        rvListAppointment.setAdapter(appointmentScheduleListClientRVAdapter);
        ...
        et_searchService.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                appointmentScheduleListClientRVAdapter = new AppointmentScheduleListClientRVAdapter(appointments, getContext());
                rvListAppointment.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
                appointmentScheduleListClientRVAdapter.setClickListener(AppointmentScheduleListClientTabInProgress.this);
                rvListAppointment.setAdapter(appointmentScheduleListClientRVAdapter);
    ...
    public void onItemClick(View view, int position) {
        String appointmentID = appointmentScheduleListClientRVAdapter.getItem(position).getAppointmentID();
        Intent intent = new Intent(getContext(), ClientInAppointmentInProgress.class);
...
//                                    return o2.getDate().compareToIgnoreCase(o1.getDate()); // Sort in descending
                            ...
                            appointmentScheduleListClientRVAdapter.notifyDataSetChanged();
                        } else {
