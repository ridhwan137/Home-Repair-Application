...
public class HistoryAppointmentListClientTabLayout extends AppCompatActivity {

    private TabLayout tabLayout;
    private ViewPager2 viewPager2;
    private HistoryAppointmentListClientTabFragmentAdapter fragmentAdapter;
...
//                        overridePendingTransition(0,0);
        ...
        fragmentAdapter = new HistoryAppointmentListClientTabFragmentAdapter(fragmentManager,getLifecycle());
