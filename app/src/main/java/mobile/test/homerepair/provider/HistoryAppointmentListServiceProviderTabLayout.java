...
public class HistoryAppointmentListServiceProviderTabLayout extends AppCompatActivity {

    private TabLayout tabLayout;
    private ViewPager2 viewPager2;
    private HistoryAppointmentListServiceProviderTabFragmentAdapter fragmentAdapter;
...
//        tabLayout.addTab(tabLayout.newTab().setText("Cancel"));
        ...
        fragmentAdapter = new HistoryAppointmentListServiceProviderTabFragmentAdapter(fragmentManager,getLifecycle());
