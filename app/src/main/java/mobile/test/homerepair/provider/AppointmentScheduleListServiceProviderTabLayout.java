...
public class AppointmentScheduleListServiceProviderTabLayout extends AppCompatActivity {

    private TabLayout tabLayout;
    private ViewPager2 viewPager2;
    private AppointmentScheduleListServiceProviderTabFragmentAdapter fragmentAdapter;
...
//                        overridePendingTransition(0,0);
        ...
        fragmentAdapter = new AppointmentScheduleListServiceProviderTabFragmentAdapter(fragmentManager,getLifecycle());
