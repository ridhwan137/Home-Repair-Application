...
public class RegisterServiceProvider extends AppCompatActivity {
    ...
    String companyName, companyNo,serviceType,address1,address2,postcode,state,city,phone,email,password,confirmPassword;

    EditText et_providerName,
            et_providerNo,
            et_providerServiceType,
            et_providerAddress1,
            et_providerAddress2,
            et_providerPostcode,
            et_providerState,
...
//        user.put("dateRegistration",date);
