...
public class AddServicesRVAdapter extends RecyclerView.Adapter<AddServicesRVAdapter.ViewHolder>{
    ...
    public AddServicesRVAdapter(ArrayList<Services> servicesArrayList, Context context) {
    ...
    @NonNull
    @Override
    public AddServicesRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.add_service_offer_row, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull AddServicesRVAdapter.ViewHolder holder, int position) {
    ...
    void setClickListener(AddServicesRVAdapter.ItemClickListener itemClickListener) {
