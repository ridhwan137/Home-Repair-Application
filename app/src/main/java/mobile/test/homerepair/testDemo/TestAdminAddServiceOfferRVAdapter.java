...
public class TestAdminAddServiceOfferRVAdapter extends RecyclerView.Adapter<TestAdminAddServiceOfferRVAdapter.ViewHolder>{
    ...
    private TestAdminAddServiceOfferRVAdapter.ItemClickListener mClickListener;

    FirebaseFirestore db = FirebaseFirestore.getInstance();

    // creating constructor for our adapter class
    public TestAdminAddServiceOfferRVAdapter(ArrayList<Services> servicesArrayList, Context context) {
    ...
    @NonNull
    @Override
    public TestAdminAddServiceOfferRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.add_service_offer_row, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull TestAdminAddServiceOfferRVAdapter.ViewHolder holder, int position) {
    ...
    void setClickListener(TestAdminAddServiceOfferRVAdapter.ItemClickListener itemClickListener) {
