...
public class TestAdminAddService extends AppCompatActivity implements TestAdminAddServiceRVAdapter.ItemClickListener{

    private RecyclerView rvServiceItem;
    private ArrayList<Services> servicesArrayList;
    private TestAdminAddServiceRVAdapter testAdminAddServiceRVAdapter;
...
//    String providerID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testAdminAddServiceRVAdapter = new TestAdminAddServiceRVAdapter(servicesArrayList, this);

        testAdminAddServiceRVAdapter.setClickListener(this);

        // setting adapter to our recycler view.
        rvServiceItem.setAdapter(testAdminAddServiceRVAdapter);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            testAdminAddServiceRVAdapter.notifyDataSetChanged();
                        } else {
...
//        serviceOffer.put("servicePrice",servicePrice);
        serviceOffer.put("serviceType",serviceName);
...
//                        intent.putExtra("userID",providerID);
                        startActivity(intent);
                        TestAdminAddService.this.finish();
